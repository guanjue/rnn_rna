...
while read -r celltype_id_num celltype; do
	...
	do
		...
		time /Users/gzx103/Documents/apps/deepTools/bin/computeMatrix scale-regions --scoreFile '/Users/gzx103/Documents/zhang_lab/projects/atacseq_vision/rna_seq_pred/ideas_labels/ideasVision.'$celltype'.'$state_id_num'.bw' --regionsFile gene_list.bed --beforeRegionStartLength 100000 --afterRegionStartLength 100000 --regionBodyLength 100000 --binSize 200 -out 'gene_list.'$celltype'.'$state_id_num'.200.tab.gz'
		time /Users/gzx103/Documents/apps/deepTools/bin/plotHeatmap -m 'gene_list.'$celltype'.'$state_id_num'.200.tab.gz' --sortUsing region_length --kmeans 1 --sortRegions no --colorMap binary --outFileName 'gene_list.'$celltype'.'$state_id_num'.200.tab.pdf'
	done
done < /Users/gzx103/Documents/zhang_lab/projects/atacseq_vision/rna_seq_pred/lists/cell_type_label3.txt

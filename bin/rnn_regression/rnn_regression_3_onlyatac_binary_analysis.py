...
saver.restore(sess, "trained_rnn_3_onlyatac_binary.ckpt")
...
for ct in cell_types:
	...
	write2d_array(y_conv_pred_test,'onlyatac3/y_conv_pred_all.'+ct+'.txt')
	write2d_array(y_conv_obs_test,'onlyatac3/y_conv_obs_all.'+ct+'.txt')
	write2d_array(y_test_sig,'onlyatac3/data_rna_sig.'+ct+'.txt')
	...
	write2d_array(rnn_hidden_layer_pred_softmax_1,'onlyatac3/rnn_hidden_layer_pred_1.'+ct+'.txt')
	write2d_array(rnn_hidden_layer_pred_softmax_2,'onlyatac3/rnn_hidden_layer_pred_2.'+ct+'.txt')
	write2d_array(rnn_hidden_layer_pred_softmax_3,'onlyatac3/rnn_hidden_layer_pred_3.'+ct+'.txt')

	write2d_array(y_test_sig,'onlyatac3/y_test_sig.'+ct+'.txt')
	write2d_array(y_test,'onlyatac3/y_test.'+ct+'.txt')

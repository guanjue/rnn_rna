...
saver.restore(sess, "trained_rnn_3_withatac_binary.ckpt")
...
for ct in cell_types:
	...
	write2d_array(y_conv_pred_test,'withatac3/y_conv_pred_all.'+ct+'.txt')
	write2d_array(y_conv_obs_test,'withatac3/y_conv_obs_all.'+ct+'.txt')
	write2d_array(y_test_sig,'withatac3/data_rna_sig.'+ct+'.txt')
	...
	write2d_array(rnn_hidden_layer_pred_softmax_1,'withatac3/rnn_hidden_layer_pred_1.'+ct+'.txt')
	write2d_array(rnn_hidden_layer_pred_softmax_2,'withatac3/rnn_hidden_layer_pred_2.'+ct+'.txt')
	write2d_array(rnn_hidden_layer_pred_softmax_3,'withatac3/rnn_hidden_layer_pred_3.'+ct+'.txt')

	write2d_array(y_test_sig,'withatac3/y_test_sig.'+ct+'.txt')
	write2d_array(y_test,'withatac3/y_test.'+ct+'.txt')

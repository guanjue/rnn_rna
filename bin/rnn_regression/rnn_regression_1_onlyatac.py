...
for i in range(iter_num):
	...
	if i%1000 == 0:
		...
		if 1==1:#accuracy_r2_test<=r2_test and accuracy_r2_train<=r2_train:
			saver = tf.train.Saver()
			save_path = saver.save(sess, "trained_rnn_1_onlyatac.ckpt")
...
'''
step 49000, TESTING accuracy same cell!!! R2: 0.723079
-2.39234347803
step 49100, training accuracy same cell!!! R2: 0.816904
step 49200, training accuracy same cell!!! R2: 0.713407
step 49300, training accuracy same cell!!! R2: 0.848038
step 49400, training accuracy same cell!!! R2: 0.672671
step 49500, training accuracy same cell!!! R2: 0.865851
step 49600, training accuracy same cell!!! R2: 0.811874
step 49700, training accuracy same cell!!! R2: 0.846024
step 49800, training accuracy same cell!!! R2: 0.787485
step 49900, training accuracy same cell!!! R2: 0.667486
-2.54933772339
step 49999, TESTING accuracy same cell!!! R2: 0.736032
'''

...
data_atac_cellspe = read_tab2matrix('/Users/gzx103/Documents/zhang_lab/projects/atacseq_vision/rna_seq_pred/matrix_for_rnn_atacpk/atac_21k_binary_split.lsk_bm.tab',1,6)
### read ideas labels
...
for i in range(iter_num):
	...
	if i%1000 == 0:
		...
		if 1==1:#accuracy_r2_test<=r2_test and accuracy_r2_train<=r2_train:
			saver = tf.train.Saver()
			save_path = saver.save(sess, "trained_rnn_3_onlyatac_binary.ckpt")

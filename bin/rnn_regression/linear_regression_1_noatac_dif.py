...
for ct in cell_types:
	...
	x_test = np.concatenate(( x_test0, (x_test0 - data_ideas_matrix[pos_test_id,:]) ), axis = 0)
	x_train = np.concatenate(( x_train0, (x_train0 - data_ideas_matrix[pos_train_id,:]) ), axis = 0)

	y_test = np.concatenate(( y_test0, (y_test0 - data_rna[pos_test_id,:]) ), axis = 0)
	y_train = np.concatenate(( y_train0, (y_train0 - data_rna[pos_train_id,:]) ), axis = 0)
